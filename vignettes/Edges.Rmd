...
sometimes it is not drawn at all but implied using containment or position 
...
dedicated to specific layouts. Let's create some graphs for illustrary purpose
first:
...
Almost all edge geoms come in three variants. The basic variant (no suffix) as 
